...
{
public:
    //Schlüsselwort 'virtual':  Es wird immer die Methode des Objektes benutzt,
    //                          auf dem die Methode aufgerufen wurde, wenn diese nicht vorhanden ist,
    //                          wird die der Basisklasse benutzt.
    
    virtual REType ofType()=0;  // '= 0' bedeutet, dass die Deklaration quasi ein Platzhalter ist.
